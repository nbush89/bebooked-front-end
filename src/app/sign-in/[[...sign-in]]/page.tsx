...
// Brand token values — Clerk's appearance API doesn't read CSS variables,
// so we pass raw hex values that mirror globals.css.
const brand = {
  nearBlack:  "#1a1209",
  warmCream:  "#faf8f3",
  warmLinen:  "#ede8e0",
...
export default function SignInPage() {
  return (
    ...
    >
      {/* Wordmark + context above the card */}
      <div
        style={{
          display: "flex",
          flexDirection: "column",
      ...
      <SignIn
        appearance={{
          ...
          elements: {
            ...
            // ── Header — hide Clerk's own logo; we show Wordmark above ──
